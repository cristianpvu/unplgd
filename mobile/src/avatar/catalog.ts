// Avatar catalog. The face features (hair/eyes/mouth/etc.) reference the
// open-source DiceBear "Adventurer" library by Lisa Wischofsky (CC BY 4.0).
// Body, clothing and the level-gated economy are original to this project.
