// Service UUID GATT pe care toate device-urile Unplgd advertise — iOS pune
// token-ul in LocalName, Android in Service Data. Scan-ul ble-plx filtreaza
// dupa acest UUID pe ambele platforme.
...
// Cat de des trimitem heartbeat de prezenta la backend cu lista de prieteni
// vazuti acum. Backend-ul tine in Redis 90s — heartbeat-ul nostru de 25s
// (mai des decat TTL-ul) garanteaza ca prezenta nu expira intre ticks.
